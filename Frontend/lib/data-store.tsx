...
type DataStoreContextType = {
  ...
  closeComplaint: (id: string, passwordConfirm: string, nocFile?: File | null) => Promise<void>;
...
export function DataStoreProvider({ children }: { children: ReactNode }) {
  ...
  const closeComplaint = useCallback(async (id: string, passwordConfirm: string, nocFile?: File | null) => {
    if (nocFile) {
